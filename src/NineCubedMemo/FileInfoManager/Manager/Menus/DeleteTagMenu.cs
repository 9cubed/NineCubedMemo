...
{
    public class DeleteTagMenu : ToolStripMenuItem
    {
        /// <summary>
        /// メインコントロール
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DeleteTagMenu(FileInfoManagerControl control, FileDB db, DataGridView grid, int tagColIndex) {
            this.Text = "タグ削除";
        ...
        private void MenuClick(object sender, EventArgs e)
        {
            ...
            //DBにタグを追加します
            var result = DeleteTag(idList, selectedTagList);
